...
def main(args):
    ...
    stage1_config, model_config, transport_config, sampler_config, guidance_config, misc, _, _ = parse_configs(args.config)
    stage1_model = instantiate_from_config(stage1_config).to(device)
    ...
    samples = stage1_model.decode(samples)
